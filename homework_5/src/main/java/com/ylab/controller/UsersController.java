...
public class UsersController {
    ...
    public ResponseEntity<List<UserForShowAndUpdateRoleDto>> viewUsers() throws JsonProcessingException {
        List<UserForShowAndUpdateRoleDto> users = userService.getAllUsers().stream().map(userMapper::toUserForShowDto).toList();
    ...
    public ResponseEntity<String> editUser(@Valid @RequestBody UserUpdateDto userUpdateDto) {
    ...
    public ResponseEntity<String> editUserRole(@Valid @RequestBody UserForShowAndUpdateRoleDto userUpdateDto) {
        CarShopUser foundedUser = userService.getUserByUsername(userUpdateDto.getUsername());
    ...
    public ResponseEntity<String> removeUser(@Valid @PathVariable String userName) throws NullPointerException {
