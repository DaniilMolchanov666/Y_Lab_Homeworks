...
public class OrderController {
    ...
    /**
     * Обработка запроса вывода заказов
     * @return список заказов и статус 200 OK
     */
    ...
    public ResponseEntity<List<OrderRequestDto>> showOrders() {
        List<OrderRequestDto> listOfOrders = orderService.viewOrders().stream()
     ...
     * @param orderFindDto - заказ для удаления
     * @return - тело ответа
     */
